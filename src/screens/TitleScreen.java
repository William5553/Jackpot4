...
public class TitleScreen extends JPanel {
    ...
    public void paint(Graphics g) {
        ...
        g2d.drawImage(logo, (this.getSize().width / 2) - (logo.getWidth(null) / 2), 140, null);
        g2d.drawImage(singleplayer, (this.getSize().width / 2) - (singleplayer.getWidth(null) / 2), 600, null);
        g2d.drawImage(multiplayer, (this.getSize().width / 2) - (multiplayer.getWidth(null) / 2), 750, null);
    }
